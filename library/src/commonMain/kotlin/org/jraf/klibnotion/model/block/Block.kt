...
class MutableBlockList(
    ...
    fun bookmark(
        ...
        add(org.jraf.klibnotion.model.block.bookmark(url, caption, linkUrl, annotations))
    ...
    fun code(
        ...
        add(org.jraf.klibnotion.model.block.code(language, text, linkUrl, annotations))
