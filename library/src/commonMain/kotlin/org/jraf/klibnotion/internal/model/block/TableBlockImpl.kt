...
internal data class TableBlockImpl(
    override val id: UuidString,
    override val created: Timestamp,
    override val lastEdited: Timestamp,
    override val tableWidth: Int,
    override val hasColumnHeader: Boolean,
    override val hasRowHeader: Boolean,
    override var children: List<Block>?,
) : TableBlock, MutableBlock
